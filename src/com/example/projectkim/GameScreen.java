...
//    	while (System.currentTimeMillis() - startTime <= 1000) {
   	//	batcher.drawSprite(160, 240, 85, 85, Assets.count3);
//    	}    	
//    	while (System.currentTimeMillis() - startTime <= 2000 && System.currentTimeMillis() - startTime >= 1000) {
//    		batcher.drawSprite(160, 240, 85, 85, Assets.count2);
//    	}
//    	while (System.currentTimeMillis() - startTime <= 3000 && System.currentTimeMillis() - startTime >= 2000) {
//        	batcher.drawSprite(160, 240, 85, 85, Assets.count1);
//    	}
//        while (System.currentTimeMillis() - startTime >= 3000 && System.currentTimeMillis() - startTime <= 4000) {
//            batcher.drawSprite(160, 240, 85, 85, Assets.go);
//        }
    	
  // if(System.currentTimeMillis()-startTime >= 3000 && System.currentTimeMillis()-startTime <= 2000) {
...
//
//    private void updateReady() {
//   	//timer.schedule((batcher.drawSpriteTimeTask(184, 176, 85, 85, Assets.count2)), 1000);
//    //  //  if(game.getInput().getTouchEvents().size() > 0) {
//            state = GAME_RUNNING;
//       // }
//    }
